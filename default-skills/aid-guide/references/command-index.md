...
| Command | Purpose |
|---|---|
| `aid setup` | Configure AID, optionally set/replace the TypeSafe (Jev) macOS keychain key with hidden terminal input and classify verification, and install bundled resources when needed. |
