...
fn make_spec(task_id: &str, worker_pid: Option<u32>, idle_timeout_secs: Option<u64>) -> BackgroundRunSpec {
    BackgroundRunSpec {
        ...
        prompt: "prompt".to_string(),
        dir: Some(".".to_string()),
        output: None, result_file: None, result_file_required: None, model: None, budget: false, session_id: None,
        ...
        audit: false, audit_explicit: false, no_audit: false, scope: vec![],
        interactive: true,
        on_done: None,
        cascade: vec![],
        parent_task_id: None,
