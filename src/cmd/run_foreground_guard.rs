...
pub(super) fn save_foreground_spec(
    ...
    ForegroundSpecGuard::save(BackgroundRunSpec {
        ...
        output: args.output.clone(), result_file: args.result_file.clone(),
        model: prepared.effective_model.clone(), verify: args.verify.clone(),
        setup: args.setup.clone(), iterate: args.iterate,
        ...
        hooks: args.hooks.clone(), template: args.template.clone(),
        worktree: args.worktree.clone(), base_branch: args.base_branch.clone(),
        peer_review: args.peer_review.clone(), audit: args.audit, scope: args.scope.clone(),
        interactive: true,
