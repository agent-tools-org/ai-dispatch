...
pub const AGENT_MODELS: &[AgentModel] = &[
    ...
    // Price unknown: grok is an account-pool window, but the CLI publishes no rate.
    ...
    AgentModel { agent: AgentKind::Grok, model: "grok-4.6", input_per_m: 0.0, output_per_m: 0.0, tier: "unknown", description: "CLI default (price unknown)", capability: 8.5 },
    AgentModel { agent: AgentKind::Grok, model: "grok-4.5", input_per_m: 0.0, output_per_m: 0.0, tier: "unknown", description: "Previous CLI model (price unknown)", capability: 8.0 },
];
